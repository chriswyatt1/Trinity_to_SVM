process SVM {
    ...
    output:
        path("./FIGURES/Figure_of_Classifiers/${name}/Classification_confidence_leave-one-out-Default.ChrisCorrect.queen.${test}.pdf") , emit: figures
    ...
    """
        ...
        cp ./FIGURES/Figure_of_Classifiers/${name}/Classification_confidence_leave-one-out-Default.ChrisCorrect.queen.pdf ./FIGURES/Figure_of_Classifiers/${name}/Classification_confidence_leave-one-out-Default.ChrisCorrect.queen.${test}.pdf
